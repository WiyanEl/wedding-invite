      ...
      {isOpen ? (
        <section id="wedding-gift" className="wedding-gift relative w-full min-h-min" style={{backgroundImage: "url('/images/ryan-dan-inggrid/bg-wishes-mobile.png')"}}>
          <div className="relative text-center pt-[95px] md:pt-[287px] pb-[74px] md:pb-[131px] font-lora text-[#FEFBF0]">
            ...
            <h6 className="text-xs md:text-lg font-medium leading-[20px] md:leading-[26px] uppercase mt-[57px] animate" data-animate="fade-up">
              <span>your prayers and presence will be the</span> <br />
              <span>greatest blessing for us.</span>
            </h6>
            <h6 className="text-xs md:text-lg font-normal leading-[20px] md:leading-[26px] mt-3 animate" data-animate="fade-up">
              <span>Should you wish to express your love with a gift,</span> <br />
              <span>kindly find the details below for your convenience.</span>
            </h6>
