            ...
            {!seeAllMessages ? (
              <div className="relative text-center pt-[90px] md:pt-[150px] font-lora text-[#FEFBF0]">
                ...
                <form onSubmit={save} className="mx-auto mt-[73px] md:mt-[89px] animate fade-up" data-animate="fade-up">
                  ...
                  <textarea value={message} onChange={(e) => setMessage(e.target.value)} className="block w-[284px] md:w-[564px] h-[106px] md:h-[261px] rounded-[10px] md:rounded-[20px] border-[0.49px] border-[#FEFBF0] border-l-[#FEFBF0]/10 bg-transparent px-[13px] md:px-[23px] py-1 font-lora text-xs md:text-lg leading-[140%] text-[#FEFBF0] mx-auto mt-4"></textarea>
