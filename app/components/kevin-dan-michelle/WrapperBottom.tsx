...
export default function WrapperBootom({ isOpen, setIsOpen, params, isMobile }: WrapperProps) {
  return (
    <div className="relative w-full overflow-y-hidden">
      ...
      <Image src="/images/kevin-dan-michelle/bg-lapisan-atas-full-bottom.png" alt="Picture of background lapisan atas" width={1308} height={6919} className="hidden md:block absolute -top-[80px] left-1/2 -translate-x-1/2" />
    </div>
  )
}