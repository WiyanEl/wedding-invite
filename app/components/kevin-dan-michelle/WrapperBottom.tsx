...
export default function WrapperBootom({ isOpen, setIsOpen, params, isMobile }: WrapperProps) {
  return (
    <div className="relative w-full">
      ...
      <Image src="/images/kevin-dan-michelle/bg-lapisan-tengah-full-bottom-mobile.png" alt="Picture of background lapisan tengah" width={346} height={3827} className="absolute top-[80px] left-1/2 -translate-x-1/2 w-[345px]" />
      <Image src="/images/kevin-dan-michelle/bg-lapisan-atas-full-bottom-mobile.png" alt="Picture of background lapisan atas" width={308} height={3715} className="absolute top-[100px] left-1/2 -translate-x-1/2 w-[308px]" />
    </div>
  )
}