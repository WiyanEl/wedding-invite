    ...
    <>
      <section id="wedding-gift" className="wedding-gift relative z-10 w-full min-h-min overflow-hidden bg-[url('/images/steven-dan-bella/bg-wedding-gift-mobile.png')] bg-cover bg-no-repeat">
        ...
        <div className="relative z-10 text-center h-full pt-[91px] pb-[99px] font-century text-[#3C475E] overflow-hidden">
          ...
          <div className="flex justify-between items-center w-[299px] border-b border-[#3C475E] pb-3 mx-auto mt-[30px] animate" data-animate="fade-up">
            ...
            <button onClick={() => handleCopy('3831660455')} className="w-[50px] h-[30px] border-b border-[#3C475E] text-center" data-animate="fade-up">
          ...
          <div className="flex justify-between items-center w-[299px] border-b border-[#3C475E] pb-3 mx-auto mt-[30px] animate" data-animate="fade-up">
            ...
            <button onClick={() => handleCopy2('249483079')} className="w-[50px] h-[30px] border-b border-[#3C475E] text-center" data-animate="fade-up">
