    ...
    <>
      <section id="location" className="relative z-10 w-full min-h-screen overflow-hidden bg-[url('/images/steven-dan-bella/bg-location-mobile.png')] md:bg-[url('/images/steven-dan-bella/bg-location.png')] bg-cover bg-top bg-no-repeat bg-fixed">
        ...
        <div className="relative z-10 text-center h-full pt-[115px] md:pt-[176px] pb-[180px] md:pb-[260px] font-century text-[#3C475E] overflow-hidden">
          ...
          <h6 className="text-[14px] md:text-2xl font-normal leading-[18px] md:leading-[25px] mt-[17px] md:mt-[18px] animate" data-animate="zoom-in">GRII Bandung</h6>
          <h6 className="text-[14px] md:text-2xl font-normal leading-[18px] md:leading-[25px] mt-2 md:mt-3 animate" data-animate="zoom-in">Jl. Moch. Toha No.229, Bandung</h6>
          ...
          <h3 className="text-base md:text-2xl font-normal leading-[18px] md:leading-[18px] uppercase mt-[44px] md:mt-[62px] animate" data-animate="zoom-in">holy matrimony</h3>
          ...
          <h6 className="text-[14px] md:text-2xl font-normal leading-[18px] md:leading-[25px] mt-[17px] md:mt-[28px] animate" data-animate="zoom-in">Mahia Resort</h6>
          <h6 className="text-[14px] md:text-2xl font-normal leading-[18px] md:leading-[25px] mt-2 md:mt-3 animate" data-animate="zoom-in">Jl. Ciwaruga No.30, Bandung</h6>
          ...
          <h3 className="text-base md:text-2xl font-normal leading-[18px] md:leading-[18px] uppercase mt-[44px] md:mt-[62px] animate" data-animate="zoom-in">tea ceremony</h3>
          <h6 className="text-base md:text-xl font-normal leading-[18px] md:leading-[18px] uppercase mt-[17px] md:mt-[36px] animate" data-animate="zoom-in">15.00 pm</h6>
          <h6 className="text-base md:text-2xl font-normal leading-[18px] md:leading-[18px] uppercase mt-[17px] md:mt-[36px] animate" data-animate="zoom-in">at Janu Chapel</h6>

          <Image src="/images/steven-dan-bella/img-dot.png" alt="Picture of Titik Hitam" width={15} height={15} className="w-[15px] md:w-[15px] mx-auto mt-[33px] md:mt-[63px] animate" data-animate="zoom-in" />

          <h3 className="text-base md:text-2xl font-normal leading-[18px] uppercase mt-[44px] md:mt-[63px] animate" data-animate="zoom-in">afternoon tea</h3>
          ...
          <h6 className="text-base md:text-xl font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Chapel</h6>

          <Image src="/images/steven-dan-bella/img-dot.png" alt="Picture of Titik Hitam" width={15} height={15} className="w-[12px] md:w-[15px] mx-auto mt-[33px] md:mt-[63px] animate" data-animate="zoom-in" />

          <h3 className="text-base md:text-2xl font-normal leading-[18px] uppercase mt-[44px] md:mt-[63px] animate" data-animate="zoom-in">wedding banquet</h3>
          <h6 className="text-base md:text-xl font-normal leading-[18px] uppercase mt-[17px] md:mt-[36px] animate" data-animate="zoom-in">18.00 pm</h6>
          ...
          <h6 className="text-base md:text-xl font-normal leading-[18px] uppercase mt-[17px] md:mt-[36px] animate" data-animate="zoom-in">22.00 pm</h6>
          <h6 className="text-base md:text-xl font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Ballroom</h6>
        </div>
        ...
        {/* Gif */}
        <Image src="/images/steven-dan-bella/animasi-kupu-kupu-2.gif" alt="Animasi Kupu-kupu" width={145} height={145} className="w-[42px] md:w-[145px] h-[42px] md:h-[145px] absolute bottom-[310px] md:bottom-[550px] left-[33px] md:left-[73px] animate" data-animate="fade-right-butterfly" />
        <Image src="/images/steven-dan-bella/animasi-kupu-kupu-1.gif" alt="Animasi Kupu-kupu" width={151} height={151} className="w-[51px] md:w-[151px] h-[51px] md:h-[151px] absolute bottom-[327px] md:bottom-[627px] right-[33px] animate" data-animate="fade-left-butterfly" />
        <Image src="/images/steven-dan-bella/animasi-kupu-kupu-1.gif" alt="Animasi Kupu-kupu" width={151} height={151} className="w-[51px] md:w-[151px] h-[51px] md:h-[151px] absolute bottom-[67px] md:bottom-[107px] right-[174px] md:right-[94px] animate" data-animate="fade-left-butterfly" />
      </section>
    </>
  )
}