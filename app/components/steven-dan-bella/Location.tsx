...
export default function Location({ isOpen, isMobile }: Props) {
  return (
    <>
      <section id="location" className="relative z-10 w-full min-h-screen overflow-hidden bg-[url('/images/steven-dan-bella/bg-location-mobile.png')] bg-cover bg-top bg-no-repeat bg-fixed">
        ...
        <div className="relative z-10 text-center h-full pt-[115px] pb-[180px] font-century text-[#3C475E] overflow-hidden">
          ...
          <h6 className="text-[14px] font-normal leading-[18px] mt-[17px] animate" data-animate="zoom-in">GRII Bandung</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-2 animate" data-animate="zoom-in">Jl. Moch. Toha No.229, Bandung</h6>
          <Link href="https://maps.app.goo.gl/R7LDN6J6yBN5Fd6v8" target="_blank" className="inline-block font-ovo text-[13px] leading-[17.16px] underline underline-offset-2 mt-[11px] animate" data-animate="zoom-in">
            Google Maps
          </Link>
          <h3 className="text-base font-normal leading-[18px] uppercase mt-[44px] animate" data-animate="zoom-in">holy matrimony</h3>
          <h6 className="text-base font-normal leading-[18px] uppercase mt-[17px] animate" data-animate="zoom-in">10.00 am</h6>
          ...
          <h6 className="text-[14px] font-normal leading-[18px] mt-[21px] animate" data-animate="zoom-in">Mahia Resort</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-2 animate" data-animate="zoom-in">Jl. Ciwaruga No.30, Bandung</h6>
          <Link href="https://maps.app.goo.gl/wH1CTg8bGano7tsa7" target="_blank" className="inline-block font-ovo text-[13px] leading-[17.16px] underline underline-offset-2 mt-[11px] animate" data-animate="zoom-in">
            Google Maps
          </Link>
          <h3 className="text-base font-normal leading-[18px] uppercase mt-[44px] animate" data-animate="zoom-in">tea ceremony</h3>
          <h6 className="text-base font-normal leading-[18px] uppercase mt-[17px] animate" data-animate="zoom-in">15.00 pm</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Chapel</h6>

          <Image src="/images/steven-dan-bella/img-dot.png" alt="Picture of Titik Hitam" width={12} height={12} className="mx-auto mt-[33px] animate" data-animate="zoom-in" />

          <h3 className="text-base font-normal leading-[18px] uppercase mt-[44px] animate" data-animate="zoom-in">afternoon tea</h3>
          <h6 className="text-base font-normal leading-[18px] uppercase mt-[27px] animate" data-animate="zoom-in">16.30 pm</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Chapel</h6>

          <Image src="/images/steven-dan-bella/img-dot.png" alt="Picture of Titik Hitam" width={12} height={12} className="mx-auto mt-[33px] animate" data-animate="zoom-in" />

          <h3 className="text-base font-normal leading-[18px] uppercase mt-[44px] animate" data-animate="zoom-in">wedding banquet</h3>
          <h6 className="text-base font-normal leading-[18px] uppercase mt-[17px] animate" data-animate="zoom-in">18.00 pm</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Ballroom</h6>

          <Image src="/images/steven-dan-bella/img-dot.png" alt="Picture of Titik Hitam" width={12} height={12} className="mx-auto mt-[33px] animate" data-animate="zoom-in" />

          <h3 className="text-base font-normal leading-[18px] uppercase mt-[44px] animate" data-animate="zoom-in">after party</h3>
          <h6 className="text-base font-normal leading-[18px] uppercase mt-[17px] animate" data-animate="zoom-in">22.00 pm</h6>
          <h6 className="text-[14px] font-normal leading-[18px] mt-6 animate" data-animate="zoom-in">at Janu Ballroom</h6>
        </div>
