      ...
      {isOpen ? (
        <footer id="footer" className="footer relative w-full min-h-screen bg-right bg-cover bg-[url('/images/steven-dan-bella/bg-footer-mobile.png')] md:bg-[url('/images/steven-dan-bella/bg-footer.png')]">
          <div className="relative h-screen text-center pt-[119px] md:pt-[205px] font-century text-white">
            <div className="absolute top-0 left-0 w-full h-[373px] md:h-[425px] bg-[linear-gradient(180deg,_#000000_0%,_rgba(0,0,0,0)_100%)]" />
            <h2 className="font-constantia text-[40px] md:text-[60px] font-normal leading-[22px] animate" data-animate="zoom-in">Thank You</h2>
            ...
            <p className="text-[14px] md:text-lg font-normal leading-[20px] md:leading-[28px] mt-6 animate" data-animate="zoom-in">#StevenBelllaAsOne</p>
            <div className="absolute bottom-0 w-full h-[90px] flex justify-center items-center">
