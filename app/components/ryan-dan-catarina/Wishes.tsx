        ...
        <section id="wishes" className="wishes relative w-full min-h-min bg-[#DADAD9] overflow-hidden">
          ...
          {!seeAllMessages ? (
            <div className="relative text-center pt-[90px] md:pt-[150px] pb-[97px] font-lora text-[#60564D]">
              <h2 className="font-bickham text-[64px] md:text-[96px] font-normal leading-[22px] md:leading-[22px] animate fade-up" data-animate="fade-up">Share Your Wishes</h2>
              ...
              <form onSubmit={save} className="mx-auto mt-[55px] md:mt-[89px] animate fade-up" data-animate="fade-up">
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="block w-[284px] md:w-[564px] h-[30px] md:h-[40px] rounded-[33px] md:rounded-[64px] border-[0.49px] border-[#60564D] bg-transparent px-[13px] md:px-[23px] py-1 font-lora text-xs md:text-lg leading-[140%] text-[#60564D] placeholder:text-[#60564D80] mx-auto" placeholder="Desy (Tester)" />
                <textarea value={message} onChange={(e) => setMessage(e.target.value)} className="block w-[284px] md:w-[564px] h-[60px] md:h-[261px] rounded-[15px] md:rounded-[20px] border-[0.49px] border-[#60564D] bg-transparent px-[13px] md:px-[23px] py-1 font-lora text-xs md:text-lg leading-[140%] text-[#60564D] mx-auto mt-4"></textarea>
