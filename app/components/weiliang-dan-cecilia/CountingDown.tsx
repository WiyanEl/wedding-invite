    ...
    <>
      {isOpen ? (
        <section id="counting-down" className="counting-down relative w-full min-h-min bg-cover bg-center" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          ...
          <Image src="/images/weiliang-dan-cecillia/img-awan-counting-down.png" alt="Awan" width={249} height={177} className={`absolute w-[209px] bottom-[-90px] left-0 animate`} data-animate="fade-up" />
