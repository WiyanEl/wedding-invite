        ...
        <>
          <section id="gallery" className="gallery relative w-full bg-cover bg-center" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
            <div className="relative overflow-hidden">
              ...
              <Image src="/images/weiliang-dan-cecillia/img-alter-gallery.png" alt="Tumbuhan Kiri" width={330} height={235} className={`absolute w-[230px] bottom-[-10px] right-0 animate`} data-animate="fade-left" />
