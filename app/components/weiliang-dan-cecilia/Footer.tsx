    ...
    <>
      {isOpen ? (
        <footer id="footer" className="footer relative w-full h-screen bg-cover bg-center overflow-hidden" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          ...
          <Image src="/images/weiliang-dan-cecillia/kupu-kupu-4.gif" alt="Butterfly Kanan" width={69} height={52} className={`absolute z-20 bottom-[214px] right-[24px] animate`} data-animate="fade-left-butterfly" />
