    ...
    <>
      {isOpen ? (
        <footer id="footer" className="footer relative w-full bg-cover bg-center overflow-hidden mt-[-50px] md:mt-[-120px]" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          ...
          <Image src="/images/weiliang-dan-cecillia/img-altar-footer.png" alt="Tanaman Atas" width={286} height={203} className={`absolute bottom-[10px] left-[67px] animate`} data-animate="fade-up" />
          ...
          <Image src="/images/weiliang-dan-cecillia/img-pengantin-footer.png" alt="Tanaman Atas" width={129} height={92} className={`absolute bottom-[40px] left-[141px] animate`} data-animate="fade-up" style={{ animationDelay: '1s' }} />
          ...
          <Image src="/images/weiliang-dan-cecillia/img-tiang-kanan-footer.png" alt="Tanaman Atas" width={169} height={293} className={`absolute bottom-[10px] right-0 animate`} data-animate="fade-left" />
          <div className="flex flex-col items-center text-center h-full pt-[255px] md:pt-[369px] pb-[331px] md:pb-[361] font-normal text-[#724232]">
            ...
            <p className="text-xs md:text-[14px] leading-[15px] animate mt-[11px]" data-animate="zoom-in">
              It would be a joy and honor for us to have you join our celebration and <br /> share your blessings.
            </p>
            <p className="text-[14px] leading-[15px] animate mt-[17px]" data-animate="zoom-in">
              #cecifoundherwei
            </p>
          </div>
        </footer>
