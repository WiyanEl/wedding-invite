      ...
      {isOpen ? (
        <section id="wedding-gift" className="wedding-gift relative w-full md:h-screen bg-cover bg-center" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          <div className="relative overflow-hidden h-full">
            ...
            <Image src="/images/weiliang-dan-cecillia/img-tiang-kanan-profile.png" alt="Tiang Kanan" width={257} height={446} className={`hidden w-[157px] md:block absolute bottom-[60px] right-0 animate`} data-animate="fade-left" />
            <Image src="/images/weiliang-dan-cecillia/kupu-kupu-4.gif" alt="Butterfly Kanan" width={69} height={52} className={`absolute z-20 bottom-[194px] right-0 animate`} data-animate="fade-left-butterfly" />
            <Image src="/images/weiliang-dan-cecillia/mini-waterfall.gif" alt="Air Terjun" width={156} height={123} className="hidden md:block absolute z-30 w-[125px] bottom-[20px] right-[-10px] animate" data-animate="fade-left" />
