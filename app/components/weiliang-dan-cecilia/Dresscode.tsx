...
export default function Dresscode({ isOpen, isMobile }: Props) {
  ...
  return (
    <>
      {isOpen ? (
        <section id="dresscode" className="dresscode relative w-full bg-cover bg-center md:mt-[-40px]" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          <div className="relative overflow-hidden">
            ...
            <Image src="/images/weiliang-dan-cecillia/img-pengantin-dress.png" alt="Pengantin" width={100} height={100} className={`absolute w-[176px] bottom-[10px] md:bottom-0 left-[23px] animate`} data-animate="fade-right-pengantin" style={{ animationDelay: '1s' }} />
            <Image src="/images/weiliang-dan-cecillia/img-air-mancur-dresscode.png" alt="Air Mancur" width={100} height={100} className={`absolute w-[78px] bottom-0 left-0 animate`} data-animate="fade-right" />
