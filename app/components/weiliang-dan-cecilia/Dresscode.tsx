      ...
      {isOpen ? (
        <section id="dresscode" className="dresscode relative w-full bg-cover bg-center" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          <div className="relative overflow-hidden">
            ...
            <Image src="/images/weiliang-dan-cecillia/img-gapura-dresscode.png" alt="Gapura" width={245} height={274} className={`absolute w-[205px] bottom-[15px] right-0 animate`} data-animate="fade-left" />
