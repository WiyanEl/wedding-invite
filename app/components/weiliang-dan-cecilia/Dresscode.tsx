      ...
      {isOpen ? (
        <section id="dresscode" className="dresscode relative w-full bg-cover bg-center" style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
          <div className="relative overflow-hidden">
            ...
            <Image src="/images/weiliang-dan-cecillia/img-air-mancur-dresscode.png" alt="Air Mancur" width={128} height={222} className={`absolute w-[78px] bottom-0 left-0 animate`} data-animate="fade-right" />
