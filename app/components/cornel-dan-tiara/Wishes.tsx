      ...
      {isOpen ? (
        <>
          ...
          <section id="wishes" className="reservation relative w-full min-h-min bg-[#F6F6F4]">
            {!seeAllMessages ? (
              <div className="relative z-10 flex flex-col items-center pt-[104px] pb-[75px] h-full text-[#3B3B3B] text-center">
                <h3 className="font-canela font-thin text-[28px] leading-[18px] uppercase animate" data-animate="fade-up">
                  your wishes
                </h3>
                <form onSubmit={save} className="flex flex-col items-center">
                  <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="mt-[38px] w-[283px] h-[26px] border-[0.49px] border-[#4E4E4E] animate bg-transparent px-1 py-3 font-outfit text-xs leading-[140%] text-[#311704]" data-animate="fade-up" />
                  <textarea value={message} onChange={(e) => setMessage(e.target.value)} className="mt-[16px] w-[283px] h-[106px] border-[0.49px] border-[#4E4E4E] animate bg-transparent px-1 py-2font-outfit text-xs leading-[140%] text-[#311704]" data-animate="fade-up"></textarea>
                  <span className="animate" data-animate="fade-up">
                    <button type="submit" className="mt-[16px] flex gap-2 justify-center items-center w-[283px] h-[30px] bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] font-outfit font-normal text-xs leading-[140%] text-[#FEFBF0] uppercase">
                      <img src="/images/cornel-dan-tiara/icon-send.png" alt="Icon send" className="w-[15px] h-[19px]" />
                      <span>send</span>
                    </button>
                  </span>
                </form>
                <div className="mt-[16px] w-[284px] h-[320px] px-[13px] py-[18px] overflow-y-auto scroll-smooth bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] animate" data-animate="fade-up">
                  {wishes.length === 0 ? (
                ...
                <span className="animate" data-animate="fade-up">
                  <button type="button" onClick={() => setSeeAllMessages(true)} className="mt-[20px] flex gap-2 justify-center items-center w-[283px] h-[30px] bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] font-outfit font-normal text-xs leading-[140%] text-[#FEFBF0] uppercase">
              ...
              <div className="relative z-10 flex flex-col items-center pb-[82px] h-full text-[#3B3B3B] text-center">
                <div className={`relative w-[340px] mt-[20px] animate'}`}>
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((wish, i) => (
                      <div
                        ...
                        className="relative w-[160px] h-[140.87px] rounded-[9.57px] bg-[#FEFBF0] border-[0.87px] border-[#4E4E4E] shadow-[5.22px_7.83px_9.74px_2.61px_#0000000F] cursor-pointer fade-up"
                ...
                <span data-animate="fade-up">
                  <button onClick={() => setSeeAllMessages(false)} className="mt-[38px] flex justify-center items-center w-[340px] h-[30px] bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] font-outfit font-normal text-sx leading-[140%] text-[#FEFBF0] uppercase">
                    back
                  </button>
                </span>
              </div>
