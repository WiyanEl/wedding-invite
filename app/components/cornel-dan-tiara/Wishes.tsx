...
export default function Wishes() {
  ...
  return (
    <section id="wishes" className="reservation relative w-full min-h-min bg-[#FEFBF0]">
      {!seeAllMessages ? (
        <div className="relative z-10 flex flex-col items-center py-[82px] h-full text-[#3B3B3B] text-center">
          ...
          <form onSubmit={save} className="flex flex-col items-center">
            ...
            <button type="submit" className={`mt-[16px] flex gap-2 justify-center items-center w-[283px] h-[30px] bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] font-outfit font-normal text-sx leading-[140%] text-[#FEFBF0] uppercase ${isVisible ? 'animate-fade-up opacity-100' : 'opacity-0 translate-y-5'}`}>
          ...
          <button type="button" onClick={() => setSeeAllMessages(true)} className={`mt-[20px] flex gap-2 justify-center items-center w-[283px] h-[30px] bg-[#4E4E4E] border-[0.49px] border-[#4E4E4E] font-outfit font-normal text-sx leading-[140%] text-[#FEFBF0] uppercase ${isVisible ? 'animate-fade-up opacity-100' : 'opacity-0 translate-y-5'}`}>
