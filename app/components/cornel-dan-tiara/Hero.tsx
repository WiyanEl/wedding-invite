...
export default function Hero({ isOpen, setIsOpen }: HeroProps) {
  ...
  const bgImage = !isOpen ? isMobile ? "/images/cornel-dan-tiara/bg-hero-mobile.png" : "/images/cornel-dan-tiara/bg-hero.png" : "/images/cornel-dan-tiara/bg-hero-mobile.png"
  ...
  return (
    <section id="hero" className={`hero relative w-full h-screen bg-cover bg-center md:bg-top`} style={{ backgroundImage: bgImage ? `url('${bgImage}')` : 'none' }}>
      ...
      <div className={`relative z-10 flex ${isOpen ? 'items-end pb-[85px]' : 'items-center'} justify-center h-full`}>
        ...
        {!isOpen && (
          <div className="text-center bg-[#FEFBF091] md:bg-[#77767291] md:opacity-70 font-outfit text-[#FEFBF0] leading-none w-[290px] md:w-[528px] min-h-min py-[60px] animate-zoom-in">
            <p className="font-medium md:font-light text-[10px] md:text-lg uppercase">
              we invite you to celebrate
            </p>
            <h2 className="font-cloudy font-normal text-[28px] md:text-[46px] leading-[31px] uppercase mt-[13px] md:mt-[15px]">
              cornel & tiara
            </h2>
            <p className="font-medium md:font-light text-[10px] md:text-lg uppercase mt-[13px] md:mt-[19px]">
            ...
            <p className="font-normal md:font-medium md:text-lg leading-[25px] text-white mt-[30px] md:mt-[31px]">
              ...
              <br />
              <span className="text-[14px]">Sela</span>
            </p>
            <p className="font-normal text-[9px] md:text-sm text-white mt-[25px] md:mt-[31px]">
