...
export default function Profile() {
  ...
  return (
    <section id="profile" className="profile relative w-full min-h-min bg-[#F6F6F4]">
      <div className="flex flex-col items-center py-[76px] h-full text-[#3B3B3B] text-center font-outfit font-normal" ref={ref}>
        <p className={`font-medium text-xs leading-[18px] ${isVisible ? 'animate-fade-up opacity-100' : 'opacity-0 translate-y-5'}`}>
        ...
        <div className={`mt-[30px] ${isVisible ? 'animate-fade-up opacity-100' : 'opacity-0 translate-y-5'}`}>
