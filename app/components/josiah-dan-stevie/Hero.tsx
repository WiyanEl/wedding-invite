          ...
          <div className="fixed inset-0 z-50">
            ...
            <div className="relative z-10 flex items-center justify-center h-full">
              <div className="w-[290px] min-h-min rounded-[15px] shadow-[0px_8px_11.6px_0px_#0000008A] zoom-in">
                <div className="w-full h-[180px] bg-center bg-cover bg-no-repeat bg-[url('/images/josiah-dan-stevie/img-popup-hero-new.png')]"></div>
                <div className="relative w-full pt-[30px] pb-[40px] rounded-bl-[15px] rounded-br-[15px] font-sorts text-[#22352F] text-center bg-center bg-cover bg-no-repeat bg-[url('/images/josiah-dan-stevie/white-paper-texture.png')]">
                  ...
                  <button onClick={() => setIsOpen(true)} className="mx-auto mt-4 w-[184px] h-[33px] bg-[#22352F] rounded-[41px] flex items-center justify-center pt-0.5">
                    <span className="text-xs leading-none font-medium text-[#FEF8EF] uppercase">view invitation</span>
                  </button>

                  {/* Image Absolute */}
                  <Image src="/images/josiah-dan-stevie/img-tanaman-kiri-popup-hero-new.png" alt="Picture of Tanaman Kiri Atas Popun Hero" width={91} height={127} className="absolute top-0 left-0" />
                  <Image src="/images/josiah-dan-stevie/img-tanaman-kanan-popup-hero-new.png" alt="Picture of Tanaman Kanan Bawah Popun Hero" width={81} height={212} className="absolute bottom-0 right-0" />
                </div>
              </div>
            </div>
          </div>
