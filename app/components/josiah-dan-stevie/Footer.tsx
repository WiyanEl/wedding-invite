...
export default function Footer({ isOpen, isMobile }: Props) {
  return (
    <>
      <footer id="footer" className="footer relative z-30 w-full min-h-screen bg-center bg-cover bg-[url('/images/josiah-dan-stevie/bg-footer-new.png')] md:bg-[url('/images/josiah-dan-stevie/bg-footer-dekstop.png')]">
